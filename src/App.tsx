...
function App() {
    ...
    const [jwtToken, setJwtToken] = useState(
        getCookie(LOCAL_STORAGE.JWT_TOKEN)
    );
    ...
    const updateSaveVideoList = (data: Video) => {
        ...
        if (!newSavedVideoList.some((video) => video.id === data.id)) {
            ...
            newSavedVideoList = newSavedVideoList.filter(
                ...
                <JWTTokenContext.Provider value={{ jwtToken, setToken }}>
                    ...
                    >
                        <SavedVideosContext.Provider
                            value={{ savedVideos, updateSaveVideoList }}
                        >
                            <ThemeContextHook.Provider
                                value={{ active: theme, toggleTheme: setTheme }}
                            >
                                <ThemeProvider
                                    theme={
                                        theme === "light"
