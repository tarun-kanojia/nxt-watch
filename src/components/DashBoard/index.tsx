                ...
                return (
                    <DashBoardElement
                        ...
                        onClick={() => {
                            ...
                            updateDashBoardList(
                                new DashBoardContentModel(dashBoardList)
                            );
                            navigate(item.path);
                        }}
                    >
                        <ElementLogo>
                            <Element
                                size="100%"
                                color={item.active ? "red" : "#606060"}
                            />
                        </ElementLogo>
                        <ElementText active={item.active}>
                            {item.title}
                        </ElementText>
                    </DashBoardElement>
                );
...
const DashBoard = () => {
    const [dashBoardContentList, setDashBoardContentList] =
        useState<DashBoardContentModel | null>(null);
    ...
    return (
        <>
            {dashBoardContentList ? (
                <DashBoardContainer>
                    <DashBoardContent
                        dashBoardList={dashBoardContentList}
